...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(128, 47)  # EMNIST 有 47 个类别
...
for i, eps in enumerate(epsilons):
    ...
    # 训练并评估 LDP-FL 模型
    accuracies_ldp_fl[i] = train_and_evaluate_model(model_ldp, optimizer_ldp, criterion, train_loader, test_loader, 10,
                                                    1 / (eps * 0.5))
...
plt.ylabel('Accuracy')
plt.title('Accuracy vs Privacy Budget on EMNIST')
plt.legend()
plt.show()
